#include "sdl_events_keyboard_event_tests.hpp"
#include "../assertion.hpp"
#include "../../Source/SDL/Events/keyboard_event.hpp"
#include <ctime>
#include "../../Source/SDL/Events/quit_event.hpp"

const std::map<std::string, std::function<void()>> Tests::SDL_EVENTS_KEYBOARD_EVENT_TESTS = {
	{
		...
		[]{
			...
			SDL::Events::KeyboardEvent test = {KEY, IS_DOWN};
	...
	},
	{
		...
		[]{
			...
			EVENT.keysym = KEYSYM;
			SDL::Events::KeyboardEvent test = {EVENT};
	...
	},
	{
		...
		[]{
			const SDL::Events::KeyboardEvent KEY_EVENT = {SDLK_j, false};
			SDL::Events::KeyboardEvent test = {SDL::Events::Event(KEY_EVENT)};
	...
	},
	{
		...
		[]{
			TestFramework::assertError<std::invalid_argument>([]{
				SDL::Events::KeyboardEvent(SDL::Events::Event(SDL::Events::QuitEvent().getEvent()));
			});
		}
	},
	{
		...
		[]{
			...
			TestFramework::assertEqual(SDL::Events::KeyboardEvent(KEY, IS_DOWN, MODIFIERS, IS_REPEAT), SDL::Events::KeyboardEvent(KEY, IS_DOWN, MODIFIERS, IS_REPEAT));
		}
	},
	{
		...
		[]{
			...
			const bool IS_REPEAT = true;
			TestFramework::assertNotEqual(SDL::Events::KeyboardEvent(KEY, IS_DOWN, MODIFIERS, IS_REPEAT), SDL::Events::KeyboardEvent(KEY, !IS_DOWN, MODIFIERS, IS_REPEAT));
			TestFramework::assertNotEqual(SDL::Events::KeyboardEvent(KEY, IS_DOWN, MODIFIERS, IS_REPEAT), SDL::Events::KeyboardEvent(KEY, IS_DOWN, MODIFIERS, !IS_REPEAT));
			TestFramework::assertNotEqual(SDL::Events::KeyboardEvent(KEY, IS_DOWN, MODIFIERS, IS_REPEAT), SDL::Events::KeyboardEvent(KEY, IS_DOWN, 0, IS_REPEAT));
			TestFramework::assertNotEqual(SDL::Events::KeyboardEvent(KEY, IS_DOWN, MODIFIERS, IS_REPEAT), SDL::Events::KeyboardEvent(SDLK_INSERT, IS_DOWN, MODIFIERS, IS_REPEAT));
		}
	}
};
