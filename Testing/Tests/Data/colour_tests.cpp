...
const std::map<std::string, std::function<void()>> Tests::Data::COLOUR_TESTS =
{
	{
	...
	},
	{
		...
		[]{
			TestFramework::assertError<std::invalid_argument>([]{ Colour(-1, 1, 1, 1); });
			TestFramework::assertError<std::invalid_argument>([]{ Colour(2, 1, 1, 1); });
			TestFramework::assertError<std::invalid_argument>([]{ Colour(1, -1, 1, 1); });
			TestFramework::assertError<std::invalid_argument>([]{ Colour(1, 2, 1, 1); });
			TestFramework::assertError<std::invalid_argument>([]{ Colour(1, 1, -1, 1); });
			TestFramework::assertError<std::invalid_argument>([]{ Colour(1, 1, 2, 1); });
			TestFramework::assertError<std::invalid_argument>([]{ Colour(1, 1, 1, -1); });
			TestFramework::assertError<std::invalid_argument>([]{ Colour(1, 1, 1, 2); });
		}
	},
	{
	...
	},
	{
		...
		[]{
			TestFramework::assertError<std::invalid_argument>([]{ Colour().setRed(-.1); });
			TestFramework::assertError<std::invalid_argument>([]{ Colour().setRed(1.1); });
		}
	},
	{
	...
	},
	{
		...
		[]{
			TestFramework::assertError<std::invalid_argument>([]{ Colour().setGreen(-.1); });
			TestFramework::assertError<std::invalid_argument>([]{ Colour().setGreen(1.1); });
		}
	},
	{
	...
	},
	{
		...
		[]{
			TestFramework::assertError<std::invalid_argument>([]{ Colour().setBlue(-.1); });
			TestFramework::assertError<std::invalid_argument>([]{ Colour().setBlue(1.1); });
		}
	},
	{
	...
	},
	{
		...
		[]{
			TestFramework::assertError<std::invalid_argument>([]{ Colour().setAlpha(-.1); });
			TestFramework::assertError<std::invalid_argument>([]{ Colour().setAlpha(1.1); });
		}
	},
	{
		...
		[]{
			...
			const float B = .93;
			const float A = 1;
			TestFramework::assertEqual(Colour(R, G, B, A), Colour(R, G, B, A));
		}
	},
	{
		...
		[]{
			...
			const float B = .501;
			const float A = 0;
			TestFramework::assertNotEqual(Colour(R, G, B, A), Colour(R + .01, G + .01, B + .01, A + .01));
		}
	}
};
