...
namespace SDL
{
	namespace Video
	{
		...
		public:
			...
			*/
			Window(const Data::Position<int>& size, const std::string& title = "", const Data::Position<int>& position = {SDL_WINDOWPOS_UNDEFINED, SDL_WINDOWPOS_UNDEFINED}, const uint32_t& flags = 0u);
			...
			*/
			void create(const Data::Position<int>& size, const std::string& title = "", const Data::Position<int>& position = {SDL_WINDOWPOS_UNDEFINED, SDL_WINDOWPOS_UNDEFINED}, const uint32_t& flags = 0u);
			/** Destroy this window
			...
			*/
			...
			\throw std::domain_error The window does not exist
			*/
			Data::Position<int> getPosition() const;
			/** Position setter
			\param position The new position
			\throw std::domain_error The window does not exist
			*/
			void setPosition(const Data::Position<int>& position);
			/** Size getter
			\return the width and height of the window in screen coordinates
			\throw std::domain_error The window does not exist
			*/
			Data::Position<int> getSize() const;
			/** Size setter
			\param size The new size
			\throw std::domain_error The window does not exist
			*/
			void setSize(const Data::Position<int>& size);
			/** Size bounds getter
			\return The bounds for the size of this window in pixels
			\throw std::domain_error The window does not exist
			*/
			Data::Bounds<Data::Position<int>> getSizeBounds() const;
			/** Size bounds setter
			\param bounds The new size bounds
			\throw std::runtiem_error The window does not exist
			*/
			void setSizeBounds(const Data::Bounds<Data::Position<int>>& bounds);
			/** Opacity getter
